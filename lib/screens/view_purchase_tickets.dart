...
import 'package:big_fun_app/utils/custom_text_form_field.dart';
import 'package:big_fun_app/utils/formulario_payment/blocs/purchase/purchase_cubit.dart';
import 'package:big_fun_app/utils/functions.dart';
import 'package:big_fun_app/utils/payment_method_view.dart';
        ...
        children: [
          ...
          FilledButton.tonalIcon(
            onPressed: (){
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) => ViewPaymentSuccessful(eventId: eventId.toString())));
            }, 
